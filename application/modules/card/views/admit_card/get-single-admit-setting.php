<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
            <th><?php echo $this->lang->line('admit_title_font_size'); ?></th>
            <td><?php echo $setting->admit_font_size; ?></td>
            <th><?php echo $this->lang->line('admit_title_color'); ?></th>
            <td><span style="padding: 4px 10px; background-color:<?php echo $setting->admit_color; ?>"></span></td>
        </tr> 
        <tr>
            <th><?php echo $this->lang->line('admit_title_background'); ?></th>
